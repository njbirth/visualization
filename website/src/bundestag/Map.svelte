<script>
    ...
    let geojson = L.geoJSON(wahlkreise, {style: style, onEachFeature: onEachFeature});
    ...
    info.update = function(feature) {
        if(feature == null)
            this._div.innerHTML = "<b>Bundesgebiet</b><hr>Klicke auf einen Wahlkreis.";
        else {
            ...
            for(let key in votes)
                votes_list.push([votes[key], key]);
            votes_list = votes_list.sort((a, b) => { return b[0] - a[0]; });
            ...
            for(let vote in votes_list) {
                ...
                content += "<tr><td>" + vote[1] + "&nbsp;&nbsp;&nbsp;</td><td>" + ((vote[0] / all_votes) * 100).toFixed(2) + "%</td><td>(" + vote[0].toLocaleString() + ")</td></tr>";
            }
            content += "</table>";
    ...
    function style(feature) {
        ...
        let most = Object.keys(data[stimmen]).reduce(function(a, b) { return data[stimmen][a] > data[stimmen][b] ? a : b });
    ...
    function onEachFeature(feature, layer) {
        ...
        layer.bindTooltip(feature.properties.WKR_NAME, {direction:"left", offset:[-20,0], sticky: true});
    }
...
<div class="text-center" style="margin: 15px">
    <ButtonGroup mandatory activeClass="red white-text" bind:value={stimmen} on:change={updateView}>
...
<div bind:this={component} style="width: 900px; height: 620px; background: #fff;"></div>